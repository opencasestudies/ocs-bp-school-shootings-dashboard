...
timerow = stringr::str_split(readtable[6], "\\|") # extracting read time row
num_min = stringr::str_split(timerow[[1]][3], " ") # extracting koRpus reading time
cat("About", round(as.numeric(num_min[[1]][1])), "minutes") # print reading time
```
