...
[googlesheets4](https://googlesheets4.tidyverse.org/) | to import directly from googlesheets
...
Alternatively, if we wanted to make a dashboard that continually updated as the data got updated, we could do the following to import the data directly from the googlesheets document.
