...
<span>Photo by <a href="https://unsplash.com/@chrismoore_?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Chris Moore</a> on <a href="https://unsplash.com/s/photos/shooting?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Unsplash</a></span>
...
[ggmap](https://www.rdocumentation.org/packages/ggmap/versions/2.6.1/topics/geocode) | to geocode the data (which means get the latitude and longitude values for the schools)
...
***
Lucily, our dat is already in pretty good shape, but we want to make our data more useful for our dashboard. 
...
Note that this step is time intensive, as there are many addresses to look up! Also, when you use Google you are agreeing to the Google Maps API Terms of Service at https://developers.google.com/maps/terms.
