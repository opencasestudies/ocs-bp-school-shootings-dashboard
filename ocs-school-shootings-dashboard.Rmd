...
shooting_data %>% filter(`Targeted Specific Victim(s)` == "No victoms")
...
inner_join(shooting_data_geocoded, shooting_data, by = c("Narrative (Detailed Summary/ Background)" = "Narrative (Detailed Summary/ Background)" ))
```
