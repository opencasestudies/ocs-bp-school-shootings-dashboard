...
The RStudio [cheatsheet for R Markdown](file:///Users/carriewright/Downloads/rmarkdown-2.0%20(1).pdf) and this [tutorial](https://ourcodingclub.github.io/tutorials/rmarkdown/) are great for getting started. 
...
4) To add columns or rows the following syntax is used `---------`. By default this notation will create new columns, however if the YAML is modifed to specify to create rows, than this same sytnax will be used to create rows.
