...
# in the case of new mexico... the rounded values add up to 99 which creates an empty extra square only when using scale_fill_viridis_d()
...
Percapita calcuations are based on 2010 population values.
