...
This branch contains an interactive Shiny version of the case study, with `learnr` exercises embedded in the original content. Run it from the project root with:
